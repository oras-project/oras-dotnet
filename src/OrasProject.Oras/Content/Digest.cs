...
internal static partial class Digest
{
    ...
    // Explanation:
    // - ^[a-z0-9]+: The algorithm part, consisting of lowercase letters and digits, followed by a colon.
    // - (?:[.+_-][a-z0-9]+)*: Optional segments of a dot, plus, underscore, or hyphen followed by lowercase letters and digits.
    // - :[a-zA-Z0-9=_-]+$: The digest part, consisting of base64url-encoded characters (letters, digits, equals, underscore, hyphen).
    // For more details, refer to the distribution specification: https://github.com/opencontainers/image-spec/blob/v1.0.1/descriptor.md#digests
