...
public partial class Reference
{
    ...
    public string? ContentReference
    {
        ...
        set
        {
            ...
            {
                _reference = value;
                _referenceType = ReferenceType.Empty;
                return;
            }
            ...
            if (value.Contains(':'))
            {
                ...
                _referenceType = ReferenceType.Digest;
                return;
            }

            _reference = ValidateReferenceAsTag(value);
            _referenceType = ReferenceType.Tag;
        }
    }
    ...
    public string Digest
    {
        get
        {
            ...
            if (_referenceType != ReferenceType.Digest)
            {
    ...
    public string Tag
    {
        get
        {
            ...
            if (_referenceType != ReferenceType.Tag)
            {
                                            ...
                                            out string error)
    {
        ...
        parsedReference = new Reference()
        {
            _registry = registry,
            _repository = path,
            _referenceType = ReferenceType.Repository
        };
    ...
    {
        if (_referenceType == ReferenceType.Empty)
        {
    ...
    private static bool TryValidateRegistry(string registry, out string error)
    {
        ...
        if (!Uri.IsWellFormedUriString("dummy://" + registry, UriKind.Absolute))
        {
        ...
        if (new Uri("dummy://" + registry).Authority != registry)
        {
