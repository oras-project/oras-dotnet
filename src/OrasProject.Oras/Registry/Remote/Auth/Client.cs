    ...
    : IClient
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var requestAttempt1 = originalRequest;
            ...
            case Challenge.Scheme.Basic:
                {
                    ...
                    var requestAttempt2 = await originalRequest.CloneAsync(cancellationToken).ConfigureAwait(false);
            ...
            case Challenge.Scheme.Bearer:
                {
                    ...
                    var requestAttempt3 = await originalRequest.CloneAsync(cancellationToken).ConfigureAwait(false);
