...
internal class Cache
{
    ...
    /// </returns>
    internal bool TryGetScheme(string registry, out Challenge.Scheme scheme)
    {
    ...
    /// </remarks>
    internal void SetCache(string registry, Challenge.Scheme scheme, string key, string token)
    {
    ...
    /// </returns>
    internal bool TryGetToken(string registry, Challenge.Scheme scheme, string key, out string token)
    {
        token = string.Empty;
        if (_caches.TryGetValue(registry, out var cacheEntry) 
